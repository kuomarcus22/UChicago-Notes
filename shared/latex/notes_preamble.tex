...
\newcommand{\chapteropening}[1]{%
  ...
  \begin{tikzpicture}[x=1in,y=1in]
    ...
    \node[anchor=west,font=\fontsize{11}{12}\selectfont\scshape] at (0,0.19) {Section \thechapter};
    \node[anchor=east,font=\fontsize{12}{14}\selectfont\itshape] at (\rr,0.19) {\notesauthor};
    \path[fill=black] (0,0.02) rectangle (\rr,0.035);
    \node[
      anchor=north west,
      font=\fontsize{22}{24}\selectfont\bfseries,
      inner sep=0pt,
      text width=0.78\chaptextwid,
      align=left
    ] at (0,-0.10) {#1};
    \node[anchor=north east,font=\fontsize{30}{30}\selectfont\bfseries] at (\rr,-0.08) {\thechapter};
  \end{tikzpicture}
  \vspace{0.26in}
  {\parindent=0pt
   \etocsettocstyle{}{}
