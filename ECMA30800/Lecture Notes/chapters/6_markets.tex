...
\begin{proof}
	...
	Let $s_1^0, s_2^0$ be a pair of signals such that it would be efficient for bidder 1 to receive $k$ units and bidder 2 to receive $m-k$ units. Notate $s^0 \coloneqq \left( s_1^0, s_2^0 \right)$. Thinking \marginimage[Partition of signals.]{3-3-2} or by referring to the image in the margin, we know
	\begin{align}
