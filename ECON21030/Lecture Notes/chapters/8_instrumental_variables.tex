...
\begin{definition}[IV conditions in potential outcomes notation]
	...
	\begin{enumerate}[label=(\roman*)]
		...
		\item \textbf{Exclusion}: for all $d,r',r''$, $y(d,r')=y(d,r'')$. So it makes sense to write $y(d) \coloneqq y(d,r')$.
...
\begin{proof}
	...
	\[
		\hat{C}^{OGMM}\coloneqq\frac{X'Z}{n}\hat{\Omega}^{-1}\xrightarrow{p}Q'\Omega^{-1}=C^{OGMM}
	.\]
