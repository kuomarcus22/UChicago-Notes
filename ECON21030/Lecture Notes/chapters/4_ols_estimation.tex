...
\begin{definition}[Residual Maker Matrix]
	...
	\]
	Therefore, the matrix $M_X\coloneqqI_n-X(X'X)^{-1}X' = I_n - P_X$ is called the residual maker.
...
\end{proposition}
\begin{proof}
	Because $(b_0,b_1)$ defines the best linear predictor of $y$ given $(1,x_1)$, the projection residual $v\coloneqqy-b_0-b_1x_1$ satisfies
	\[
		\E[v]=0
		\qquad \text{and} \qquad
		\E[v x_1]=0.
