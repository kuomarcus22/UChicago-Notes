...
% Visual target: wide outer margin, boxed marginalia, compact chapter openers,
% centered captions above tables/figures, rounded code blocks, and restrained
% running heads/feet.
...
% Boxed-note backends. Normal mode places notes in the margin with optional
% vertical offsets; cheatsheet mode converts them to footnotes.
